...
public class RSPQLParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"','", "'BASE'", "'ROUND'", "'STRSTARTS'", "'DISTINCT'", "'DESCRIBE'", 
		"'VALUES'", "'ASC'", "'ENCODE_FOR_URI'", "'DSTREAM'", "'PREFIX'", "'>='", 
		"'MINUTES'", "'<'", "']'", "'ASK'", "'ISLITERAL'", "'TZ'", "'OPTIONAL'", 
		"'IRI'", "'CONSTRUCT'", "'+'", "'SHA256'", "'TRUE'", "'SILENT'", "'AS'", 
		"'WINDOW'", "'WHERE'", "'COALESCE'", "'STRDT'", "'DATATYPE'", "';'", "'UNION'", 
		"'ON'", "'}'", "'STRLEN'", "'CEIL'", "'*'", "'SELECT'", "'ISIRI'", "'STRLANG'", 
		"'SHA1'", "'DAY'", "'MIN'", "'['", "'NOW'", "'|'", "'BIND'", "'STR'", 
		"'HOURS'", "'!'", "'SUBSTR'", "'GROUP_CONCAT'", "')'", "'DESC'", "'FILTER'", 
		"'SECONDS'", "'LCASE'", "'GRAPH'", "'FROM'", "'FLOOR'", "'{'", "'ISBLANK'", 
		"'LANGMATCHES'", "'GROUP'", "'REGISTER'", "'CONTAINS'", "'BNODE'", "'UNDEF'", 
		"'UUID'", "'SHA384'", "'('", "'MD5'", "'MONTH'", "'REPLACE'", "'FALSE'", 
		"'STEP'", "'YEAR'", "'SUM'", "'URI'", "'HAVING'", "'UCASE'", "'CONCAT'", 
		"'MAX'", "'BOUND'", "'/'", "'LIMIT'", "'STRUUID'", "'STRENDS'", "'BY'", 
		"'ISNUMERIC'", "'DEFAULT'", "'||'", "'ISURI'", "'IF'", "'NOT'", "'?'", 
		"'<='", "'SHA512'", "'REGEX'", "'RANGE'", "'ISTREAM'", "'ORDER'", "'OFFSET'", 
		"'.'", "'MINUS'", "'SERVICE'", "'STRAFTER'", "'AVG'", "'COUNT'", "'ELEMENTS'", 
		"'RSTREAM'", "'>'", "'IN'", "'SAMETERM'", "'REDUCED'", "'-'", "TYPE", 
		"COMMENT", "DURATION", "IRIREF", "PNAME_NS", "PNAME_LN", "BLANK_NODE_LABEL", 
	...
	public final QueryContext query() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(286); prologue();
			setState(288);
			_la = _input.LA(1);
			if (_la==T__51) {
				{
				setState(287); registerClause();
				}
			}
			...
			case T__78:
				{
				setState(290); selectQuery();
				}
				break;
			case T__96:
				{
				setState(291); constructQuery();
				}
				break;
			case T__111:
				{
				setState(292); describeQuery();
				}
				break;
			case T__101:
				{
				setState(293); askQuery();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(296); valuesClause();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrologueContext prologue() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==T__115 || _la==T__106) {
				{
				setState(300);
				switch (_input.LA(1)) {
				case T__115:
					{
					setState(298); baseDecl();
					}
					break;
				case T__106:
					{
					setState(299); prefixDecl();
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final BaseDeclContext baseDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(305); match(T__115);
			setState(306); match(IRIREF);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrefixDeclContext prefixDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(308); match(T__106);
			setState(309); match(PNAME_NS);
			setState(310); match(IRIREF);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RegisterClauseContext registerClause() throws RecognitionException {
		...
		try {
			...
			setState(313); outputStreamType();
			setState(314); outputStream();
			setState(315); match(T__91);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OutputStreamTypeContext outputStreamType() throws RecognitionException {
		...
		try {
			...
			setState(317);
			_la = _input.LA(1);
			if ( !(_la==T__107 || _la==T__15 || _la==T__5) ) {
	...
	public final SelectQueryContext selectQuery() throws RecognitionException {
		...
		try {
			...
			setState(328); whereClause();
			setState(329); solutionModifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SubSelectContext subSelect() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(331); selectClause();
			setState(332); whereClause();
			setState(333); solutionModifier();
			setState(334); valuesClause();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SelectClauseContext selectClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(336); match(T__78);
			setState(339);
			switch (_input.LA(1)) {
			case T__112:
				{
				setState(337); distinct();
				}
				break;
			case T__1:
				{
				setState(338); reduced();
				}
				break;
			case T__79:
			case T__45:
			...
			case VAR2:
				...
				do {
					{
					{
					setState(341); resultVar();
					}
					}
					setState(344); 
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & ((1L << (T__45 - 86)) | (1L << (VAR1 - 86)) | (1L << (VAR2 - 86)))) != 0) );
				}
				break;
			case T__79:
				{
				setState(346); resultStar();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ResultVarContext resultVar() throws RecognitionException {
		...
		try {
			...
			case T__45:
				...
				{
				{
				setState(352); match(T__45);
				setState(353); expression();
				setState(354); match(T__91);
				setState(355); var();
				setState(356); match(T__63);
				}
				}
				break;
			default:
	...
	public final ConstructQueryContext constructQuery() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(364); match(T__96);
			setState(388);
			switch (_input.LA(1)) {
			case T__55:
				{
				setState(365); constructTemplate();
				setState(369);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__57) {
				...
				setState(372); whereClause();
				setState(373); solutionModifier();
				}
				break;
			case T__89:
			case T__57:
				...
				setState(381); match(T__89);
				setState(382); match(T__55);
				setState(384);
				_la = _input.LA(1);
				if (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__72 - 38)) | (1L << (T__45 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (BLANK_NODE_LABEL - 135)) | (1L << (VAR1 - 135)) | (1L << (VAR2 - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)) | (1L << (NIL - 135)) | (1L << (ANON - 135)))) != 0)) {
					{
					setState(383); triplesTemplate();
					}
				}

				setState(386); match(T__82);
	...
	public final DescribeQueryContext describeQuery() throws RecognitionException {
		...
		try {
			...
			setState(406);
			_la = _input.LA(1);
			if (_la==T__89 || _la==T__55) {
				{
				setState(405); whereClause();
				}
			}

			setState(408); solutionModifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AskQueryContext askQuery() throws RecognitionException {
		...
		try {
			...
			setState(417); whereClause();
			setState(418); solutionModifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DatasetClauseContext datasetClause() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(421); defaultGraphClause();
				}
				break;

			case 2:
				{
				setState(422); namedGraphClause();
				}
				break;

			case 3:
				{
				setState(423); namedWindowClause();
				}
				break;
			}
			}
	...
	public final NamedGraphClauseContext namedGraphClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(428); match(T__119);
			setState(429); sourceSelector();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final NamedWindowClauseContext namedWindowClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(431); match(T__119);
			setState(432); match(T__90);
			setState(433); windowUri();
			setState(434); match(T__83);
			setState(435); streamUri();
			setState(436); match(T__72);
			setState(437); window();
			setState(438); match(T__102);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WindowContext window() throws RecognitionException {
		...
		try {
			...
			case T__6:
				enterOuterAlt(_localctx, 1);
				{
				setState(444); physicalWindow();
				}
				break;
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(445); logicalWindow();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PhysicalWindowContext physicalWindow() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(448); physicalRange();
			setState(450);
			_la = _input.LA(1);
			if (_la==T__40) {
				{
				setState(449); physicalStep();
				}
			}
	...
	public final PhysicalRangeContext physicalRange() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(452); match(T__6);
			setState(453); integer();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PhysicalStepContext physicalStep() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(455); match(T__40);
			setState(456); integer();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LogicalWindowContext logicalWindow() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(458); logicalRange();
			setState(460);
			_la = _input.LA(1);
			if (_la==T__40) {
				{
				setState(459); logicalStep();
				}
			}
	...
	public final LogicalRangeContext logicalRange() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(462); match(T__16);
			setState(463); duration();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LogicalStepContext logicalStep() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(465); match(T__40);
			setState(466); duration();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WhereClauseContext whereClause() throws RecognitionException {
		...
		try {
			...
			if (_la==T__89) {
				{
				setState(472); match(T__89);
				}
			}

			setState(475); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SolutionModifierContext solutionModifier() throws RecognitionException {
		...
		try {
			...
			if (_la==T__30 || _la==T__13) {
				{
				setState(486); limitOffsetClauses();
				}
			}
	...
	public final GroupClauseContext groupClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(489); match(T__52);
			setState(490); match(T__27);
			setState(492); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				{
				{
				setState(491); groupCondition();
				}
				}
				setState(494); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__129) | (1L << T__128) | (1L << T__126) | (1L << T__125) | (1L << T__124) | (1L << T__118) | (1L << T__117) | (1L << T__114) | (1L << T__113) | (1L << T__108) | (1L << T__104) | (1L << T__100) | (1L << T__99) | (1L << T__97) | (1L << T__94) | (1L << T__88) | (1L << T__87) | (1L << T__86) | (1L << T__81) | (1L << T__80) | (1L << T__77) | (1L << T__76) | (1L << T__75) | (1L << T__74) | (1L << T__73) | (1L << T__71) | (1L << T__68))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (T__67 - 64)) | (1L << (T__65 - 64)) | (1L << (T__64 - 64)) | (1L << (T__60 - 64)) | (1L << (T__59 - 64)) | (1L << (T__56 - 64)) | (1L << (T__54 - 64)) | (1L << (T__53 - 64)) | (1L << (T__50 - 64)) | (1L << (T__49 - 64)) | (1L << (T__47 - 64)) | (1L << (T__46 - 64)) | (1L << (T__45 - 64)) | (1L << (T__44 - 64)) | (1L << (T__43 - 64)) | (1L << (T__42 - 64)) | (1L << (T__39 - 64)) | (1L << (T__38 - 64)) | (1L << (T__37 - 64)) | (1L << (T__35 - 64)) | (1L << (T__34 - 64)) | (1L << (T__33 - 64)) | (1L << (T__32 - 64)) | (1L << (T__29 - 64)) | (1L << (T__28 - 64)) | (1L << (T__26 - 64)) | (1L << (T__23 - 64)) | (1L << (T__22 - 64)) | (1L << (T__21 - 64)) | (1L << (T__18 - 64)) | (1L << (T__17 - 64)) | (1L << (T__9 - 64)) | (1L << (T__8 - 64)) | (1L << (T__7 - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (T__2 - 129)) | (1L << (IRIREF - 129)) | (1L << (PNAME_NS - 129)) | (1L << (PNAME_LN - 129)) | (1L << (VAR1 - 129)) | (1L << (VAR2 - 129)))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GroupConditionContext groupCondition() throws RecognitionException {
		...
		try {
			...
			case PNAME_LN:
				enterOuterAlt(_localctx, 2);
				{
				setState(497); functionCall();
				}
				break;
			case T__45:
				enterOuterAlt(_localctx, 3);
				{
				setState(498); match(T__45);
				setState(499); expression();
				setState(502);
				_la = _input.LA(1);
				if (_la==T__91) {
					{
					setState(500); match(T__91);
					setState(501); var();
					}
				}

				setState(504); match(T__63);
				}
				break;
			case VAR1:
			case VAR2:
	...
	public final HavingClauseContext havingClause() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(510); havingCondition();
				}
				}
				setState(513); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__129) | (1L << T__128) | (1L << T__126) | (1L << T__125) | (1L << T__124) | (1L << T__118) | (1L << T__117) | (1L << T__114) | (1L << T__113) | (1L << T__108) | (1L << T__104) | (1L << T__100) | (1L << T__99) | (1L << T__97) | (1L << T__94) | (1L << T__88) | (1L << T__87) | (1L << T__86) | (1L << T__81) | (1L << T__80) | (1L << T__77) | (1L << T__76) | (1L << T__75) | (1L << T__74) | (1L << T__73) | (1L << T__71) | (1L << T__68))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (T__67 - 64)) | (1L << (T__65 - 64)) | (1L << (T__64 - 64)) | (1L << (T__60 - 64)) | (1L << (T__59 - 64)) | (1L << (T__56 - 64)) | (1L << (T__54 - 64)) | (1L << (T__53 - 64)) | (1L << (T__50 - 64)) | (1L << (T__49 - 64)) | (1L << (T__47 - 64)) | (1L << (T__46 - 64)) | (1L << (T__45 - 64)) | (1L << (T__44 - 64)) | (1L << (T__43 - 64)) | (1L << (T__42 - 64)) | (1L << (T__39 - 64)) | (1L << (T__38 - 64)) | (1L << (T__37 - 64)) | (1L << (T__35 - 64)) | (1L << (T__34 - 64)) | (1L << (T__33 - 64)) | (1L << (T__32 - 64)) | (1L << (T__29 - 64)) | (1L << (T__28 - 64)) | (1L << (T__26 - 64)) | (1L << (T__23 - 64)) | (1L << (T__22 - 64)) | (1L << (T__21 - 64)) | (1L << (T__18 - 64)) | (1L << (T__17 - 64)) | (1L << (T__9 - 64)) | (1L << (T__8 - 64)) | (1L << (T__7 - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (T__2 - 129)) | (1L << (IRIREF - 129)) | (1L << (PNAME_NS - 129)) | (1L << (PNAME_LN - 129)))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OrderClauseContext orderClause() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(519); orderCondition();
				}
				}
				setState(522); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__129) | (1L << T__128) | (1L << T__126) | (1L << T__125) | (1L << T__124) | (1L << T__118) | (1L << T__117) | (1L << T__114) | (1L << T__113) | (1L << T__109) | (1L << T__108) | (1L << T__104) | (1L << T__100) | (1L << T__99) | (1L << T__97) | (1L << T__94) | (1L << T__88) | (1L << T__87) | (1L << T__86) | (1L << T__81) | (1L << T__80) | (1L << T__77) | (1L << T__76) | (1L << T__75) | (1L << T__74) | (1L << T__73) | (1L << T__71) | (1L << T__68))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (T__67 - 64)) | (1L << (T__65 - 64)) | (1L << (T__64 - 64)) | (1L << (T__62 - 64)) | (1L << (T__60 - 64)) | (1L << (T__59 - 64)) | (1L << (T__56 - 64)) | (1L << (T__54 - 64)) | (1L << (T__53 - 64)) | (1L << (T__50 - 64)) | (1L << (T__49 - 64)) | (1L << (T__47 - 64)) | (1L << (T__46 - 64)) | (1L << (T__45 - 64)) | (1L << (T__44 - 64)) | (1L << (T__43 - 64)) | (1L << (T__42 - 64)) | (1L << (T__39 - 64)) | (1L << (T__38 - 64)) | (1L << (T__37 - 64)) | (1L << (T__35 - 64)) | (1L << (T__34 - 64)) | (1L << (T__33 - 64)) | (1L << (T__32 - 64)) | (1L << (T__29 - 64)) | (1L << (T__28 - 64)) | (1L << (T__26 - 64)) | (1L << (T__23 - 64)) | (1L << (T__22 - 64)) | (1L << (T__21 - 64)) | (1L << (T__18 - 64)) | (1L << (T__17 - 64)) | (1L << (T__9 - 64)) | (1L << (T__8 - 64)) | (1L << (T__7 - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (T__2 - 129)) | (1L << (IRIREF - 129)) | (1L << (PNAME_NS - 129)) | (1L << (PNAME_LN - 129)) | (1L << (VAR1 - 129)) | (1L << (VAR2 - 129)))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OrderConditionContext orderCondition() throws RecognitionException {
		...
		try {
			...
			case T__62:
				...
				setState(524);
				_la = _input.LA(1);
				if ( !(_la==T__109 || _la==T__62) ) {
				_errHandler.recoverInline(this);
				}
				consume();
				setState(525); brackettedExpression();
				}
				}
				break;
			case T__129:
	...
	public final LimitOffsetClausesContext limitOffsetClauses() throws RecognitionException {
		...
		try {
			...
			case T__30:
				enterOuterAlt(_localctx, 1);
				{
				setState(532); limitClause();
				setState(534);
				_la = _input.LA(1);
				if (_la==T__13) {
					{
					setState(533); offsetClause();
					}
				}
			...
			case T__13:
				enterOuterAlt(_localctx, 2);
				{
				setState(536); offsetClause();
				setState(538);
				_la = _input.LA(1);
				if (_la==T__30) {
					{
					setState(537); limitClause();
					}
				}
	...
	public final LimitClauseContext limitClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(542); match(T__30);
			setState(543); match(INTEGER);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OffsetClauseContext offsetClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(545); match(T__13);
			setState(546); match(INTEGER);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ValuesClauseContext valuesClause() throws RecognitionException {
		...
		try {
			...
			if (_la==T__110) {
				{
				setState(548); match(T__110);
				setState(549); dataBlock();
				}
			}
	...
	public final QuadsNotTriplesContext quadsNotTriples() throws RecognitionException {
		...
		try {
			...
			setState(582); varOrIri();
			setState(583); match(T__55);
			setState(585);
			_la = _input.LA(1);
			if (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__72 - 38)) | (1L << (T__45 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (BLANK_NODE_LABEL - 135)) | (1L << (VAR1 - 135)) | (1L << (VAR2 - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)) | (1L << (NIL - 135)) | (1L << (ANON - 135)))) != 0)) {
				{
				setState(584); triplesTemplate();
				}
			}

			setState(587); match(T__82);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TriplesTemplateContext triplesTemplate() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(589); triplesSameSubject();
			setState(594);
			_la = _input.LA(1);
			if (_la==T__12) {
				{
				setState(590); match(T__12);
				setState(592);
				_la = _input.LA(1);
				if (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__72 - 38)) | (1L << (T__45 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (BLANK_NODE_LABEL - 135)) | (1L << (VAR1 - 135)) | (1L << (VAR2 - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)) | (1L << (NIL - 135)) | (1L << (ANON - 135)))) != 0)) {
					{
					setState(591); triplesTemplate();
					}
				}
	...
	public final GroupGraphPatternContext groupGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(596); match(T__55);
			setState(599);
			switch (_input.LA(1)) {
			case T__78:
				{
				setState(597); subSelect();
				}
				break;
			case T__110:
			case T__98:
			...
			case ANON:
				{
				setState(598); groupGraphPatternSub();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(601); match(T__82);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GroupGraphPatternSubContext groupGraphPatternSub() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__110) | (1L << T__98) | (1L << T__90) | (1L << T__69))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__61 - 70)) | (1L << (T__58 - 70)) | (1L << (T__55 - 70)) | (1L << (T__11 - 70)) | (1L << (T__10 - 70)))) != 0)) {
				{
				{
				setState(606); graphPatternNotTriples();
				setState(608);
				_la = _input.LA(1);
				if (_la==T__12) {
					{
					setState(607); match(T__12);
					}
				}
	...
	public final TriplesBlockContext triplesBlock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(618); triplesSameSubjectPath();
			setState(623);
			_la = _input.LA(1);
			if (_la==T__12) {
				{
				setState(619); match(T__12);
				setState(621);
				_la = _input.LA(1);
				if (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__72 - 38)) | (1L << (T__45 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (BLANK_NODE_LABEL - 135)) | (1L << (VAR1 - 135)) | (1L << (VAR2 - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)) | (1L << (NIL - 135)) | (1L << (ANON - 135)))) != 0)) {
					{
					setState(620); triplesBlock();
					}
				}
	...
	public final GraphPatternNotTriplesContext graphPatternNotTriples() throws RecognitionException {
		...
		try {
			...
			case T__55:
				enterOuterAlt(_localctx, 1);
				{
				setState(625); groupOrUnionGraphPattern();
				}
				break;
			case T__98:
				enterOuterAlt(_localctx, 2);
				{
				setState(626); optionalGraphPattern();
				}
				break;
			case T__11:
				enterOuterAlt(_localctx, 3);
				{
				setState(627); minusGraphPattern();
				}
				break;
			case T__58:
				enterOuterAlt(_localctx, 4);
				{
				setState(628); graphGraphPattern();
				}
				break;
			case T__90:
				enterOuterAlt(_localctx, 5);
				{
				setState(629); windowGraphPattern();
				}
				break;
			case T__10:
				enterOuterAlt(_localctx, 6);
				{
				setState(630); serviceGraphPattern();
				}
				break;
			case T__61:
	...
	public final OptionalGraphPatternContext optionalGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(636); match(T__98);
			setState(637); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GraphGraphPatternContext graphGraphPattern() throws RecognitionException {
		...
		try {
			...
			setState(640); varOrIri();
			setState(641); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WindowGraphPatternContext windowGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(643); match(T__90);
			setState(644); varOrIri();
			setState(645); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ServiceGraphPatternContext serviceGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(647); match(T__10);
			setState(649);
			_la = _input.LA(1);
			if (_la==T__92) {
				{
				setState(648); match(T__92);
				}
			}

			setState(651); varOrIri();
			setState(652); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BindContext bind() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(654); match(T__69);
			setState(655); match(T__45);
			setState(656); expression();
			setState(657); match(T__91);
			setState(658); var();
			setState(659); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InlineDataContext inlineData() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(661); match(T__110);
			setState(662); dataBlock();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InlineDataOneVarContext inlineDataOneVar() throws RecognitionException {
		...
		try {
			...
			{
			setState(668); var();
			setState(669); match(T__55);
			setState(673);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__48 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)))) != 0)) {
				{
				{
				setState(670); dataBlockValue();
				}
				}
				setState(675);
				_errHandler.sync(this);
	...
	public final InlineDataFullContext inlineDataFull() throws RecognitionException {
		...
		try {
			...
			case T__45:
				...
				setState(686); match(T__63);
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(689); match(T__55);
			setState(694);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__45 || _la==NIL) {
				{
				setState(692);
				switch (_input.LA(1)) {
				case T__45:
					{
					setState(690); dataBlockValues();
					}
					break;
				case NIL:
					{
					setState(691); match(NIL);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final MinusGraphPatternContext minusGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(717); match(T__11);
			setState(718); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GroupOrUnionGraphPatternContext groupOrUnionGraphPattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(720); groupGraphPattern();
			setState(725);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__84) {
				{
				{
				setState(721); match(T__84);
				setState(722); groupGraphPattern();
				}
				}
				setState(727);
				_errHandler.sync(this);
	...
	public final FilterContext filter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(728); match(T__61);
			setState(729); constraint();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstraintContext constraint() throws RecognitionException {
		...
		try {
			...
			case T__45:
				enterOuterAlt(_localctx, 1);
				{
				setState(731); brackettedExpression();
				}
				break;
			case T__129:
			case T__128:
	...
	public final ArgListContext argList() throws RecognitionException {
		...
		try {
			...
			case NIL:
				enterOuterAlt(_localctx, 1);
				{
				setState(739); match(NIL);
				}
				break;
			case T__45:
				enterOuterAlt(_localctx, 2);
				{
				setState(740); match(T__45);
				setState(742);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(741); distinct();
					}
				}
	...
	public final ExpressionListContext expressionList() throws RecognitionException {
		...
		try {
			...
			case NIL:
				enterOuterAlt(_localctx, 1);
				{
				setState(756); match(NIL);
				}
				break;
			case T__45:
				enterOuterAlt(_localctx, 2);
				{
				setState(757); match(T__45);
	...
	public final ConstructTemplateContext constructTemplate() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(770); match(T__55);
			setState(771); quads();
			setState(772); match(T__82);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstructTriplesContext constructTriples() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(774); triplesSameSubject();
			setState(779);
	...
	public final TriplesSameSubjectContext triplesSameSubject() throws RecognitionException {
		...
		try {
			...
			case ANON:
				enterOuterAlt(_localctx, 1);
				{
				setState(781); varOrTerm();
				setState(782); propertyListNotEmpty();
				}
				break;
			case T__72:
			case T__45:
	...
	public final PropertyListNotEmptyContext propertyListNotEmpty() throws RecognitionException {
		...
		try {
			...
			while (_la==T__85) {
				{
				{
				setState(791); match(T__85);
				setState(793);
				_la = _input.LA(1);
				if (((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & ((1L << (TYPE - 132)) | (1L << (IRIREF - 132)) | (1L << (PNAME_NS - 132)) | (1L << (PNAME_LN - 132)) | (1L << (VAR1 - 132)) | (1L << (VAR2 - 132)))) != 0)) {
					{
					setState(792); propertyList();
					}
				}
	...
	public final TriplesSameSubjectPathContext triplesSameSubjectPath() throws RecognitionException {
		...
		try {
			...
			case ANON:
				enterOuterAlt(_localctx, 1);
				{
				setState(819); varOrTerm();
				setState(820); propertyListPathNotEmpty();
				}
				break;
			case T__72:
			case T__45:
				enterOuterAlt(_localctx, 2);
				{
				setState(822); triplesNodePath();
				setState(824);
				_la = _input.LA(1);
				if (_la==T__120 || _la==T__66 || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & ((1L << (T__45 - 86)) | (1L << (TYPE - 86)) | (1L << (IRIREF - 86)) | (1L << (PNAME_NS - 86)) | (1L << (PNAME_LN - 86)) | (1L << (VAR1 - 86)) | (1L << (VAR2 - 86)))) != 0)) {
					{
					setState(823); propertyListPathNotEmpty();
					}
				}
	...
	public final PropertyListPathNotEmptyContext propertyListPathNotEmpty() throws RecognitionException {
		...
		try {
			...
			while (_la==T__85) {
				{
				{
				setState(829); match(T__85);
				setState(830); propertyListPath();
				}
				}
				setState(835);
				_errHandler.sync(this);
	...
	public final PropertyListPathContext propertyListPath() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(836); verbPath();
				}
				break;

			case 2:
				{
				setState(837); verbSimple();
				}
				break;
			}
			setState(840); objectListPath();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ObjectListPathContext objectListPath() throws RecognitionException {
		...
		try {
			...
			while (_la==T__116) {
				{
				{
				setState(849); match(T__116);
				setState(850); objectPath();
				}
				}
				setState(855);
				_errHandler.sync(this);
	...
	public final PathAlternativeContext pathAlternative() throws RecognitionException {
		...
		try {
			...
			while (_la==T__70) {
				{
				{
				setState(861); match(T__70);
				setState(862); pathSequence();
				}
				}
				setState(867);
				_errHandler.sync(this);
	...
	public final PathSequenceContext pathSequence() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(869); match(T__31);
				setState(870); pathEltOrInverse();
				}
				}
				setState(875);
				_errHandler.sync(this);
	...
	public final PathEltContext pathElt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(876); pathPrimary();
			setState(878);
			_la = _input.LA(1);
			if (_la==T__95 || _la==T__79 || _la==T__20) {
				{
				setState(877); pathMod();
				}
			}
	...
	public final PathEltOrInverseContext pathEltOrInverse() throws RecognitionException {
		...
		try {
			...
			case PNAME_LN:
				enterOuterAlt(_localctx, 1);
				{
				setState(880); pathElt();
				}
				break;
			case T__120:
				enterOuterAlt(_localctx, 2);
				{
				setState(881); match(T__120);
				setState(882); pathElt();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PathPrimaryContext pathPrimary() throws RecognitionException {
		...
		try {
			...
			case T__66:
				enterOuterAlt(_localctx, 3);
				{
				setState(889); match(T__66);
				setState(890); pathNegatedPropertySet();
				}
				break;
			case T__45:
				enterOuterAlt(_localctx, 4);
				{
				setState(891); match(T__45);
				setState(892); path();
				setState(893); match(T__63);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PathNegatedPropertySetContext pathNegatedPropertySet() throws RecognitionException {
		...
		try {
			...
			case PNAME_LN:
				enterOuterAlt(_localctx, 1);
				{
				setState(897); pathOneInPropertySet();
				}
				break;
			case T__45:
				enterOuterAlt(_localctx, 2);
				{
				setState(898); match(T__45);
				setState(907);
				_la = _input.LA(1);
				if (_la==T__120 || ((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & ((1L << (TYPE - 132)) | (1L << (IRIREF - 132)) | (1L << (PNAME_NS - 132)) | (1L << (PNAME_LN - 132)))) != 0)) {
					{
					setState(899); pathOneInPropertySet();
					setState(904);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==T__70) {
						{
						{
						setState(900); match(T__70);
						setState(901); pathOneInPropertySet();
						}
						}
						setState(906);
						_errHandler.sync(this);
	...
	public final TriplesNodeContext triplesNode() throws RecognitionException {
		...
		try {
			...
			case T__45:
				enterOuterAlt(_localctx, 1);
				{
				setState(923); collection();
				}
				break;
			case T__72:
				enterOuterAlt(_localctx, 2);
				{
				setState(924); blankNodePropertyList();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BlankNodePropertyListContext blankNodePropertyList() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(927); match(T__72);
			setState(928); propertyListNotEmpty();
			setState(929); match(T__102);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TriplesNodePathContext triplesNodePath() throws RecognitionException {
		...
		try {
			...
			case T__45:
				enterOuterAlt(_localctx, 1);
				{
				setState(931); collectionPath();
				}
				break;
			case T__72:
				enterOuterAlt(_localctx, 2);
				{
				setState(932); blankNodePropertyListPath();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BlankNodePropertyListPathContext blankNodePropertyListPath() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(935); match(T__72);
			setState(936); propertyListPathNotEmpty();
			setState(937); match(T__102);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CollectionContext collection() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(940); graphNode();
				}
				}
				setState(943); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (T__93 - 38)) | (1L << (T__72 - 38)) | (1L << (T__45 - 38)) | (1L << (T__41 - 38)))) != 0) || ((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & ((1L << (IRIREF - 135)) | (1L << (PNAME_NS - 135)) | (1L << (PNAME_LN - 135)) | (1L << (BLANK_NODE_LABEL - 135)) | (1L << (VAR1 - 135)) | (1L << (VAR2 - 135)) | (1L << (INTEGER - 135)) | (1L << (DECIMAL - 135)) | (1L << (DOUBLE - 135)) | (1L << (INTEGER_POSITIVE - 135)) | (1L << (DECIMAL_POSITIVE - 135)) | (1L << (DOUBLE_POSITIVE - 135)) | (1L << (INTEGER_NEGATIVE - 135)) | (1L << (DECIMAL_NEGATIVE - 135)) | (1L << (DOUBLE_NEGATIVE - 135)) | (1L << (STRING_LITERAL1 - 135)) | (1L << (STRING_LITERAL2 - 135)) | (1L << (STRING_LITERAL_LONG1 - 135)) | (1L << (STRING_LITERAL_LONG2 - 135)) | (1L << (NIL - 135)) | (1L << (ANON - 135)))) != 0) );
			setState(945); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GraphTermContext graphTerm() throws RecognitionException {
		...
		try {
			...
			case ANON:
				enterOuterAlt(_localctx, 5);
				{
				setState(977); blankNode();
				}
				break;
			case NIL:
				enterOuterAlt(_localctx, 6);
				{
				setState(978); match(NIL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(981); conditionalOrExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConditionalOrExpressionContext conditionalOrExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(983); conditionalAndExpression();
			setState(988);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__24) {
				{
				{
				setState(984); match(T__24);
				setState(985); conditionalAndExpression();
				}
				}
				setState(990);
				_errHandler.sync(this);
	...
	public final ConditionalAndExpressionContext conditionalAndExpression() throws RecognitionException {
		...
		try {
			...
			while (_la==T__122) {
				{
				{
				setState(992); match(T__122);
				setState(993); valueLogical();
				}
				}
				setState(998);
				_errHandler.sync(this);
	...
	public final ValueLogicalContext valueLogical() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(999); relationalExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RelationalExpressionContext relationalExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1001); numericExpression();
			setState(1019);
			switch (_input.LA(1)) {
			case T__121:
				{
				setState(1002); match(T__121);
				setState(1003); numericExpression();
				}
				break;
			case T__127:
				{
				setState(1004); match(T__127);
				setState(1005); numericExpression();
				}
				break;
			case T__103:
				{
				setState(1006); match(T__103);
				setState(1007); numericExpression();
				}
				break;
			case T__4:
				{
				setState(1008); match(T__4);
				setState(1009); numericExpression();
				}
				break;
			case T__19:
				{
				setState(1010); match(T__19);
				setState(1011); numericExpression();
				}
				break;
			case T__105:
				{
				setState(1012); match(T__105);
				setState(1013); numericExpression();
				}
				break;
			case T__3:
				{
				setState(1014); match(T__3);
				setState(1015); expressionList();
				}
				break;
			case T__21:
				{
				setState(1016); match(T__21);
				setState(1017); match(T__3);
	...
	public final NumericExpressionContext numericExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1021); additiveExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AdditiveExpressionContext additiveExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1023); multiplicativeExpression();
			setState(1027);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__95 || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (T__0 - 131)) | (1L << (INTEGER_POSITIVE - 131)) | (1L << (DECIMAL_POSITIVE - 131)) | (1L << (DOUBLE_POSITIVE - 131)) | (1L << (INTEGER_NEGATIVE - 131)) | (1L << (DECIMAL_NEGATIVE - 131)) | (1L << (DOUBLE_NEGATIVE - 131)))) != 0)) {
				{
				{
				setState(1024); multiExpr();
				}
				}
				setState(1029);
				_errHandler.sync(this);
	...
	public final MultiExprContext multiExpr() throws RecognitionException {
		...
		try {
			...
			case T__95:
				enterOuterAlt(_localctx, 1);
				{
				setState(1030); match(T__95);
				setState(1031); multiplicativeExpression();
				}
				break;
			case T__0:
				enterOuterAlt(_localctx, 2);
				{
				setState(1032); match(T__0);
				setState(1033); multiplicativeExpression();
				}
				break;
			case INTEGER_POSITIVE:
			case DECIMAL_POSITIVE:
			...
			case DOUBLE_NEGATIVE:
				...
				case DOUBLE_POSITIVE:
					{
					setState(1034); numericLiteralPositive();
					}
					break;
				case INTEGER_NEGATIVE:
				case DECIMAL_NEGATIVE:
				case DOUBLE_NEGATIVE:
					{
					setState(1035); numericLiteralNegative();
					}
					break;
				default:
					throw new NoViableAltException(this);
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__79 || _la==T__31) {
					{
					setState(1042);
					switch (_input.LA(1)) {
					case T__79:
						{
						setState(1038); match(T__79);
						setState(1039); unaryExpression();
						}
						break;
					case T__31:
						{
						setState(1040); match(T__31);
						setState(1041); unaryExpression();
						}
						break;
					default:
						throw new NoViableAltException(this);
	...
	public final MultiplicativeExpressionContext multiplicativeExpression() throws RecognitionException {
		...
		try {
			...
			while (_la==T__79 || _la==T__31) {
				...
				case T__79:
					{
					setState(1050); match(T__79);
					setState(1051); unaryExpression();
					}
					break;
				case T__31:
					{
					setState(1052); match(T__31);
					setState(1053); unaryExpression();
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final UnaryExpressionContext unaryExpression() throws RecognitionException {
		...
		try {
			...
			case T__66:
				enterOuterAlt(_localctx, 1);
				{
				setState(1059); match(T__66);
				setState(1060); primaryExpression();
				}
				break;
			case T__95:
				enterOuterAlt(_localctx, 2);
				{
				setState(1061); match(T__95);
				setState(1062); primaryExpression();
				}
				break;
			case T__0:
				enterOuterAlt(_localctx, 3);
				{
				setState(1063); match(T__0);
				setState(1064); primaryExpression();
				}
				break;
			case T__129:
			case T__128:
			...
			case STRING_LITERAL_LONG2:
				enterOuterAlt(_localctx, 4);
				{
				setState(1065); primaryExpression();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PrimaryExpressionContext primaryExpression() throws RecognitionException {
		...
		try {
			...
			case T__45:
				enterOuterAlt(_localctx, 1);
				{
				setState(1068); brackettedExpression();
				}
				break;
			case T__129:
			case T__128:
	...
	public final BrackettedExpressionContext brackettedExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1077); match(T__45);
			setState(1078); expression();
			setState(1079); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BuiltInCallContext builtInCall() throws RecognitionException {
		...
		try {
			...
			case T__7:
				enterOuterAlt(_localctx, 1);
				{
				setState(1081); aggregate();
				}
				break;
			case T__68:
				enterOuterAlt(_localctx, 2);
				{
				setState(1082); match(T__68);
				setState(1083); match(T__45);
				setState(1084); expression();
				setState(1085); match(T__63);
				}
				break;
			case T__117:
				enterOuterAlt(_localctx, 3);
				{
				setState(1087); match(T__117);
				setState(1088); match(T__45);
				setState(1089); expression();
				setState(1090); match(T__63);
				}
				break;
			case T__53:
				enterOuterAlt(_localctx, 4);
				{
				setState(1092); match(T__53);
				setState(1093); match(T__45);
				setState(1094); expression();
				setState(1095); match(T__116);
				setState(1096); expression();
				setState(1097); match(T__63);
				}
				break;
			case T__86:
				enterOuterAlt(_localctx, 5);
				{
				setState(1099); match(T__86);
				setState(1100); match(T__45);
				setState(1101); expression();
				setState(1102); match(T__63);
				}
				break;
			case T__32:
				enterOuterAlt(_localctx, 6);
				{
				setState(1104); match(T__32);
				setState(1105); match(T__45);
				setState(1106); var();
				setState(1107); match(T__63);
				}
				break;
			case T__97:
				enterOuterAlt(_localctx, 7);
				{
				setState(1109); match(T__97);
				setState(1110); match(T__45);
				setState(1111); expression();
				setState(1112); match(T__63);
				}
				break;
			case T__37:
				enterOuterAlt(_localctx, 8);
				{
				setState(1114); match(T__37);
				setState(1115); match(T__45);
				setState(1116); expression();
				setState(1117); match(T__63);
				}
				break;
			case T__49:
				enterOuterAlt(_localctx, 9);
				{
				setState(1119); match(T__49);
				setState(1125);
				switch (_input.LA(1)) {
				case T__45:
					{
					setState(1120); match(T__45);
					setState(1121); expression();
					setState(1122); match(T__63);
					}
					break;
				case NIL:
					{
					setState(1124); match(NIL);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case T__124:
				...
				{
				setState(1127); match(T__124);
				setState(1128); match(NIL);
				}
				break;
			case T__129:
				enterOuterAlt(_localctx, 11);
				{
				setState(1129); match(T__129);
				setState(1130); match(T__45);
				setState(1131); expression();
				setState(1132); match(T__63);
				}
				break;
			case T__80:
				enterOuterAlt(_localctx, 12);
				{
				setState(1134); match(T__80);
				setState(1135); match(T__45);
				setState(1136); expression();
			...
			case T__56:
				...
				{
				setState(1139); match(T__56);
				setState(1140); match(T__45);
				setState(1141); expression();
				setState(1142); match(T__63);
				}
				break;
			case T__114:
				enterOuterAlt(_localctx, 14);
				{
				setState(1144); match(T__114);
				setState(1145); match(T__45);
				setState(1146); expression();
				setState(1147); match(T__63);
				}
				break;
			case T__34:
				enterOuterAlt(_localctx, 15);
				{
				setState(1149); match(T__34);
				setState(1150); expressionList();
				}
				break;
			case T__65:
				enterOuterAlt(_localctx, 16);
				{
				setState(1151); substringExpression();
				}
				break;
			case T__81:
				enterOuterAlt(_localctx, 17);
				{
				setState(1152); match(T__81);
				setState(1153); match(T__45);
				setState(1154); expression();
				setState(1155); match(T__63);
				}
				break;
			case T__42:
				enterOuterAlt(_localctx, 18);
				{
				setState(1157); strReplaceExpression();
				}
				break;
			case T__35:
				enterOuterAlt(_localctx, 19);
				{
				setState(1158); match(T__35);
				setState(1159); match(T__45);
				setState(1160); expression();
				setState(1161); match(T__63);
				}
				break;
			case T__59:
				enterOuterAlt(_localctx, 20);
				{
				setState(1163); match(T__59);
				setState(1164); match(T__45);
				setState(1165); expression();
				setState(1166); match(T__63);
				}
				break;
			case T__108:
				enterOuterAlt(_localctx, 21);
				{
				setState(1168); match(T__108);
				setState(1169); match(T__45);
				setState(1170); expression();
				setState(1171); match(T__63);
				}
				break;
			case T__50:
				enterOuterAlt(_localctx, 22);
				{
				setState(1173); match(T__50);
				setState(1174); match(T__45);
				setState(1175); expression();
				setState(1176); match(T__116);
				setState(1177); expression();
				setState(1178); match(T__63);
				}
				break;
			case T__113:
				enterOuterAlt(_localctx, 23);
				{
				setState(1180); match(T__113);
				setState(1181); match(T__45);
				setState(1182); expression();
				setState(1183); match(T__116);
				setState(1184); expression();
				setState(1185); match(T__63);
				}
				break;
			case T__28:
				enterOuterAlt(_localctx, 24);
				{
				setState(1187); match(T__28);
				setState(1188); match(T__45);
				setState(1189); expression();
				setState(1190); match(T__116);
				setState(1191); expression();
				setState(1192); match(T__63);
				}
				break;
			case T__118:
				enterOuterAlt(_localctx, 25);
				{
				setState(1194); match(T__118);
				setState(1195); match(T__45);
				setState(1196); expression();
				setState(1197); match(T__116);
				setState(1198); expression();
				setState(1199); match(T__63);
				}
				break;
			case T__9:
				enterOuterAlt(_localctx, 26);
				{
				setState(1201); match(T__9);
				setState(1202); match(T__45);
				setState(1203); expression();
				setState(1204); match(T__116);
				setState(1205); expression();
				setState(1206); match(T__63);
				}
				break;
			case T__39:
				enterOuterAlt(_localctx, 27);
				{
				setState(1208); match(T__39);
				setState(1209); match(T__45);
				setState(1210); expression();
				setState(1211); match(T__63);
				}
				break;
			case T__43:
				enterOuterAlt(_localctx, 28);
				{
				setState(1213); match(T__43);
				setState(1214); match(T__45);
				setState(1215); expression();
				setState(1216); match(T__63);
				}
				break;
			case T__74:
				enterOuterAlt(_localctx, 29);
				{
				setState(1218); match(T__74);
				setState(1219); match(T__45);
				setState(1220); expression();
				setState(1221); match(T__63);
				}
				break;
			case T__67:
				enterOuterAlt(_localctx, 30);
				{
				setState(1223); match(T__67);
				setState(1224); match(T__45);
				setState(1225); expression();
				setState(1226); match(T__63);
				}
				break;
			case T__104:
				enterOuterAlt(_localctx, 31);
				{
				setState(1228); match(T__104);
				setState(1229); match(T__45);
				setState(1230); expression();
				setState(1231); match(T__63);
				}
				break;
			case T__60:
				...
				setState(1234); match(T__45);
				setState(1235); expression();
				setState(1236); match(T__63);
				}
				break;
			case T__125:
				enterOuterAlt(_localctx, 33);
				{
				setState(1238); match(T__125);
				setState(1239); match(T__45);
				setState(1240); expression();
				setState(1241); match(T__63);
				}
				break;
			case T__99:
				enterOuterAlt(_localctx, 34);
				{
				setState(1243); match(T__99);
				setState(1244); match(T__45);
				setState(1245); expression();
				setState(1246); match(T__63);
				}
				break;
			case T__71:
				enterOuterAlt(_localctx, 35);
				{
				setState(1248); match(T__71);
				setState(1249); match(NIL);
				}
				break;
			case T__47:
				enterOuterAlt(_localctx, 36);
				{
				setState(1250); match(T__47);
				setState(1251); match(NIL);
				}
				break;
			case T__29:
				enterOuterAlt(_localctx, 37);
				{
				setState(1252); match(T__29);
				setState(1253); match(NIL);
				}
				break;
			case T__44:
				enterOuterAlt(_localctx, 38);
				{
				setState(1254); match(T__44);
				setState(1255); match(T__45);
				setState(1256); expression();
				setState(1257); match(T__63);
				}
				break;
			case T__75:
				enterOuterAlt(_localctx, 39);
				{
				setState(1259); match(T__75);
				setState(1260); match(T__45);
				setState(1261); expression();
				setState(1262); match(T__63);
				}
				break;
			case T__94:
				enterOuterAlt(_localctx, 40);
				{
				setState(1264); match(T__94);
				setState(1265); match(T__45);
				setState(1266); expression();
				setState(1267); match(T__63);
				}
				break;
			case T__46:
				enterOuterAlt(_localctx, 41);
				{
				setState(1269); match(T__46);
				setState(1270); match(T__45);
				setState(1271); expression();
				setState(1272); match(T__63);
				}
				break;
			case T__18:
				enterOuterAlt(_localctx, 42);
				{
				setState(1274); match(T__18);
				setState(1275); match(T__45);
				setState(1276); expression();
				setState(1277); match(T__63);
				}
				break;
			case T__88:
				enterOuterAlt(_localctx, 43);
				{
				setState(1279); match(T__88);
			...
			case T__22:
				...
				{
				setState(1281); match(T__22);
				setState(1282); match(T__45);
				setState(1283); expression();
				setState(1284); match(T__116);
				setState(1285); expression();
				setState(1286); match(T__116);
				setState(1287); expression();
				setState(1288); match(T__63);
				}
				break;
			case T__76:
				enterOuterAlt(_localctx, 45);
				{
				setState(1290); match(T__76);
				setState(1291); match(T__45);
				setState(1292); expression();
				setState(1293); match(T__116);
				setState(1294); expression();
				setState(1295); match(T__63);
				}
				break;
			case T__87:
				enterOuterAlt(_localctx, 46);
				{
				setState(1297); match(T__87);
				setState(1298); match(T__45);
				setState(1299); expression();
				setState(1300); match(T__116);
				setState(1301); expression();
				setState(1302); match(T__63);
				}
				break;
			case T__2:
				enterOuterAlt(_localctx, 47);
				{
				setState(1304); match(T__2);
				setState(1305); match(T__45);
				setState(1306); expression();
				setState(1307); match(T__116);
				setState(1308); expression();
				setState(1309); match(T__63);
				}
				break;
			case T__77:
				enterOuterAlt(_localctx, 48);
				{
				setState(1311); match(T__77);
				setState(1312); match(T__45);
				setState(1313); expression();
				setState(1314); match(T__63);
				}
				break;
			case T__23:
				enterOuterAlt(_localctx, 49);
				{
				setState(1316); match(T__23);
				setState(1317); match(T__45);
				setState(1318); expression();
				setState(1319); match(T__63);
				}
				break;
			case T__54:
				enterOuterAlt(_localctx, 50);
				{
				setState(1321); match(T__54);
				setState(1322); match(T__45);
				setState(1323); expression();
				setState(1324); match(T__63);
				}
				break;
			case T__100:
				enterOuterAlt(_localctx, 51);
				{
				setState(1326); match(T__100);
				setState(1327); match(T__45);
				setState(1328); expression();
				setState(1329); match(T__63);
				}
				break;
			case T__26:
				enterOuterAlt(_localctx, 52);
				{
				setState(1331); match(T__26);
				setState(1332); match(T__45);
				setState(1333); expression();
				setState(1334); match(T__63);
				}
				break;
			case T__17:
				enterOuterAlt(_localctx, 53);
				{
				setState(1336); regexExpression();
				}
				break;
			case T__126:
				enterOuterAlt(_localctx, 54);
				{
				setState(1337); existsFunc();
				}
				break;
			case T__21:
				enterOuterAlt(_localctx, 55);
				{
				setState(1338); notExistsFunc();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final RegexExpressionContext regexExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1341); match(T__17);
			setState(1342); match(T__45);
			setState(1343); expression();
			setState(1344); match(T__116);
			setState(1345); expression();
			setState(1348);
			_la = _input.LA(1);
			if (_la==T__116) {
				{
				setState(1346); match(T__116);
				setState(1347); expression();
				}
			}

			setState(1350); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SubstringExpressionContext substringExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1352); match(T__65);
			setState(1353); match(T__45);
			setState(1354); expression();
			setState(1355); match(T__116);
			setState(1356); expression();
			setState(1359);
			_la = _input.LA(1);
			if (_la==T__116) {
				{
				setState(1357); match(T__116);
				setState(1358); expression();
				}
			}

			setState(1361); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StrReplaceExpressionContext strReplaceExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1363); match(T__42);
			setState(1364); match(T__45);
			setState(1365); expression();
			setState(1366); match(T__116);
			setState(1367); expression();
			setState(1368); match(T__116);
			setState(1369); expression();
			setState(1372);
			_la = _input.LA(1);
			if (_la==T__116) {
				{
				setState(1370); match(T__116);
				setState(1371); expression();
				}
			}

			setState(1374); match(T__63);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExistsFuncContext existsFunc() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1376); match(T__126);
			setState(1377); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final NotExistsFuncContext notExistsFunc() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1379); match(T__21);
			setState(1380); match(T__126);
			setState(1381); groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AggregateContext aggregate() throws RecognitionException {
		...
		try {
			...
			case T__7:
				enterOuterAlt(_localctx, 1);
				{
				setState(1383); match(T__7);
				setState(1384); match(T__45);
				setState(1386);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1385); distinct();
					}
				}
				...
				case STRING_LITERAL_LONG2:
					{
					setState(1389); expression();
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(1392); match(T__63);
				}
				break;
			case T__38:
				enterOuterAlt(_localctx, 2);
				{
				setState(1393); match(T__38);
				setState(1394); match(T__45);
				setState(1396);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1395); distinct();
					}
				}

				setState(1398); expression();
				setState(1399); match(T__63);
				}
				break;
			case T__73:
				enterOuterAlt(_localctx, 3);
				{
				setState(1401); match(T__73);
				setState(1402); match(T__45);
				setState(1404);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1403); distinct();
					}
				}

				setState(1406); expression();
				setState(1407); match(T__63);
				}
				break;
			case T__33:
				enterOuterAlt(_localctx, 4);
				{
				setState(1409); match(T__33);
				setState(1410); match(T__45);
				setState(1412);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1411); distinct();
					}
				}

				setState(1414); expression();
				setState(1415); match(T__63);
				}
				break;
			case T__8:
				enterOuterAlt(_localctx, 5);
				{
				setState(1417); match(T__8);
				setState(1418); match(T__45);
				setState(1420);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1419); distinct();
					}
				}

				setState(1422); expression();
				setState(1423); match(T__63);
				}
				break;
			case T__128:
				enterOuterAlt(_localctx, 6);
				{
				setState(1425); match(T__128);
				setState(1426); match(T__45);
				setState(1428);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1427); distinct();
					}
				}

				setState(1430); expression();
				setState(1431); match(T__63);
				}
				break;
			case T__64:
				enterOuterAlt(_localctx, 7);
				{
				setState(1433); match(T__64);
				setState(1434); match(T__45);
				setState(1436);
				_la = _input.LA(1);
				if (_la==T__112) {
					{
					setState(1435); distinct();
					}
				}
				...
				if (_la==T__85) {
					{
					setState(1439); match(T__85);
					setState(1440); match(T__130);
					setState(1441); match(T__121);
					setState(1442); string();
					}
				}

				setState(1445); match(T__63);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final IriOrFunctionContext iriOrFunction() throws RecognitionException {
		...
		try {
			...
			setState(1451);
			_la = _input.LA(1);
			if (_la==T__45 || _la==NIL) {
				{
				setState(1450); argList();
				}
			}
	...
	public final RdfliteralContext rdfliteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1453); string();
			setState(1457);
			switch (_input.LA(1)) {
			case LANGTAG:
				{
				setState(1454); match(LANGTAG);
				}
				break;
			case T__123:
				{
				{
				setState(1455); match(T__123);
				setState(1456); iri();
				}
				}
				break;
	...
	public final NumericLiteralContext numericLiteral() throws RecognitionException {
		...
		try {
			...
			case DOUBLE:
				enterOuterAlt(_localctx, 1);
				{
				setState(1459); numericLiteralUnsigned();
				}
				break;
			case INTEGER_POSITIVE:
			case DECIMAL_POSITIVE:
			case DOUBLE_POSITIVE:
				enterOuterAlt(_localctx, 2);
				{
				setState(1460); numericLiteralPositive();
				}
				break;
			case INTEGER_NEGATIVE:
			case DECIMAL_NEGATIVE:
			case DOUBLE_NEGATIVE:
				enterOuterAlt(_localctx, 3);
				{
				setState(1461); numericLiteralNegative();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\u00e8\u00ea\u00ec\u00ee\u00f0\u00f2\u00f4\u00f6\u00f8\u00fa\u00fc\u00fe"+
		"\u0100\u0102\u0104\u0106\u0108\u010a\u010c\u010e\u0110\u0112\u0114\u0116"+
		"\u0118\u011a\u011c\2\r\5\2\32\32vv\u0080\u0080\4\2\30\30GG\5\2&&\66\66"+
		"qq\3\2\u008d\u008e\3\2\u0090\u0092\3\2\u0093\u0095\3\2\u0096\u0098\4\2"+
		"((\\\\\3\2\u009a\u009d\3\2\u008a\u008b\4\2\u008c\u008c\u00a1\u00a1\u0628"+
		"\2\u011e\3\2\2\2\4\u0120\3\2\2\2\6\u0130\3\2\2\2\b\u0133\3\2\2\2\n\u0136"+
		"\3\2\2\2\f\u013a\3\2\2\2\16\u013f\3\2\2\2\20\u0141\3\2\2\2\22\u0143\3"+
		"\2\2\2\24\u014d\3\2\2\2\26\u0152\3\2\2\2\30\u015f\3\2\2\2\32\u0168\3\2"+
		"\2\2\34\u016a\3\2\2\2\36\u016c\3\2\2\2 \u016e\3\2\2\2\"\u0188\3\2\2\2"+
		"$\u019c\3\2\2\2&\u01a6\3\2\2\2(\u01ac\3\2\2\2*\u01ae\3\2\2\2,\u01b1\3"+
		"\2\2\2.\u01ba\3\2\2\2\60\u01bc\3\2\2\2\62\u01c0\3\2\2\2\64\u01c2\3\2\2"+
		"\2\66\u01c6\3\2\2\28\u01c9\3\2\2\2:\u01cc\3\2\2\2<\u01d0\3\2\2\2>\u01d3"+
		"\3\2\2\2@\u01d6\3\2\2\2B\u01d8\3\2\2\2D\u01db\3\2\2\2F\u01e0\3\2\2\2H"+
		"\u01eb\3\2\2\2J\u01fd\3\2\2\2L\u01ff\3\2\2\2N\u0205\3\2\2\2P\u0207\3\2"+
