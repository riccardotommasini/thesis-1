...
public class SJSONTriple extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static SJSONTriple.Builder newBuilder() {
    return new SJSONTriple.Builder();
  }
   ...
   * @return A new SJSONTriple RecordBuilder
   */
  public static SJSONTriple.Builder newBuilder(SJSONTriple.Builder other) {
    return new SJSONTriple.Builder(other);
  }
   ...
   * @return A new SJSONTriple RecordBuilder
   */
  public static SJSONTriple.Builder newBuilder(SJSONTriple other) {
    return new SJSONTriple.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SJSONTriple>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(SJSONTriple.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(SJSONTriple other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.s)) {
        this.s = data().deepCopy(fields()[0].schema(), other.s);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder setS(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder setP(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder clearP() {
      p = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder setO(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder clearO() {
      o = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder setTs(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SJSONTriple.Builder clearTs() {
